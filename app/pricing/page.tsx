  ...
  return (
    <div className="min-h-screen bg-[#0B0E14]">
      ...
      <main className="container-shell py-16">
        <Badge>Pricing</Badge>
        <h1 className="mt-5 font-heading text-4xl font-bold text-white">Simple plans for disciplined traders.</h1>
        <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-400">
          Start with a concise daily email, or unlock the full analytics and performance workspace.
        </p>
