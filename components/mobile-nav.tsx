...
export function MobileNav() {
  ...
  function renderItems(items: typeof primaryNavItems) {
    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          {renderItems(primaryNavItems)}
          <DropdownMenu.Separator className="my-2 h-px bg-white/10" />
          <DropdownMenu.Label className="px-3 pb-1 pt-1 data-label">
            Performance
          </DropdownMenu.Label>
          {renderItems(performanceNavItems)}
          <DropdownMenu.Separator className="my-2 h-px bg-white/10" />
